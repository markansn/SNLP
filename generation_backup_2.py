...
articles = [
    {
        ...
        'highlights': 'Critically acclaimed series "Orphan Black" returns .\n"Turn: Washington\'s Spies" starts a second season .\n"Game of Thrones" is back for season five .',
        'id': '00dddbedf41ec993a8b976f3cce2dd8ca2c7efed'},
    {
        ...
        'highlights': "The ramp agent fell asleep in the plane's cargo hold .\nHe can no longer work on Alaska Airlines flights .",
        'id': '00e5eb6c1af59233b661e59b0954a4f84a2f3904'},
    {
...
# "ainize/bart-base-cnn" "facebook/bart-large-cnn" "flax-commun ity/t5-base-cnn-dm" "sshleifer/distilbart-cnn-6-6" "patrickvonplaten/bert2bert_cnn_daily_mail" "google/roberta2roberta_L-24_cnn_daily_mail"
model, tokenizer = get_pretrained("Ayham/roberta_gpt2_summarization_cnn_dailymail")
